...
export default function SideBar() {
  ...
  return (
    <div
      className="absolute w-[88px] h-[964px] bg-white top-[100px] left-[-4] shadow-[0px_3px_6px_#00000029] rounded-lg flex flex-col items-center py-5 z-50 transition-[width] duration-300 ease-in-out hover:w-[250px] group"
