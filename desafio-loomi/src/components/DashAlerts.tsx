...
export default function DashAlerts(props: any) {
    return (
      <div className="top-[192px] left-[144px] w-[236px] h-[168px] bg-white rounded-[15px] opacity-100 flex flex-col justify-center items-center p-4 space-y-6 mb-4">
        ...
        <h4 className="top-[280px] left-[160px] w-[128px] h-[16px] text-left font-ubuntu font-normal text-[14px] leading-[16px] tracking-normal text-[#D6628E] opacity-100">
          {props.subtitulo}
        </h4>
